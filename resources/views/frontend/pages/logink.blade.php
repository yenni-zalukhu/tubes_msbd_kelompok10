...
<head>
  <title>Anisa Collection Store || Login Page</title>
          ...
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block bg-login-image">
                <img src="{{ asset('backend/img/admin_login.png') }}" alt="Logo">
            </div>
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user"  method="POST" action="{{ route('logink.submit') }}">
                    @csrf
                    ...
                    <button type="submit" class="btn-user btn-block">
                      Login
                    </button>
                  </form>
                  <hr>
