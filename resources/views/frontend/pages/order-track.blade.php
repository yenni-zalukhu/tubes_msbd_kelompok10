...
@section('title','Anisa Collection Store || Order Track Page')
...
<section class="tracking_box_area section_gap py-5">
    <div class="container">
        <div class="tracking_box_inner">
            <p>Untuk melacak pesanan Anda, silakan masukkan ID Pesanan Anda pada kolom di bawah ini lalu tekan tombol “Lacak”.</p>
