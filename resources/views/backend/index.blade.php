...
@section('title','Anisa Collection Store || DASHBOARD')
        ...
        <div class="card border-left-primary shadow h-100 py-2">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col mr-2">
                <div class="text-xs font-weight-bold text-uppercase mb-1" style="color: #00008B;">Category</div>
...
<script type="text/javascript">
  ...
  <script type="text/javascript">
    ...
    .then(function (response) {
        const data_keys = Object.keys(response.data); // Nama bulan
        const data_values = Object.values(response.data); // Total pendapatan

        // Membuat grafik area chart
        var ctx = document.getElementById("myAreaChart");
        var myLineChart = new Chart(ctx, {
            type: 'line',
            data: {
                labels: data_keys, // ["January", "February", ...]
                datasets: [{
                    label: "Earnings",
                    lineTension: 0.3,
    ...
    .catch(function (error) {
        console.error(error); // Tampilkan error di console jika ada masalah
    });
