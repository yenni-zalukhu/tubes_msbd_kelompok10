  <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center"
          href="{{ route(Auth::user()->role === 'admin' ? 'admin' : 'kasir') }}">
      ...
      @elseif(Auth::check() && Auth::user()->role === 'kasir')
          {{-- <li class="nav-item">
              ...
              <div id="categoryCollapse" class="collapse" aria-labelledby="headingTwo"
                  data-parent="#accordionSidebar">
                  <div class="bg-white py-2 collapse-inner rounded">
                      <h6 class="collapse-header">Transaction Options:</h6>
                      <a class="collapse-item" href="{{ route('category.index') }}">Transaction</a>
